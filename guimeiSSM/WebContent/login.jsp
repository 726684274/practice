...
<div id="container">
	...
	<div class="login">
		<ul class="form f_l">
			...
			<li class="login_list"><label>会员名：</label><input type="text" name="username" />（可包含 a-z、0-9 和下划线）</li>
			<li class="login_list"><label>密&nbsp;&nbsp;&nbsp;码：</label><input type="password" name="password" />（至少包含 6 个字符）</li>
			<li class="a_c"><input type="image" src="images/login.gif" value="登录"></li>
