...
<header  style="margin: 0 auto">
    <iframe src="header.html" name="headFrame" id="head" height="160px" frameborder="0" scrolling="no" width="100%"></iframe>
</header>
<div  style="margin: 0 auto;width: 980px">
    ...
    <div style="width: 785px;float: right">
        <iframe src="center.jsp"  frameborder="0" scrolling="no" width="100%" name="center"
                onload="this.height=this.contentWindow.document.documentElement.scrollHeight"> success</iframe>
    </div>
