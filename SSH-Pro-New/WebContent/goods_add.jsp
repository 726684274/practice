        ...
        <section class="right">
            <section class="right_top">
                <ul>
                    ...
                    <li><span>${GMSG }</span></li>
                </ul>
            </section>
            <div class="line"></div>
            <section class="right_middle">
            <form action="goodsaddaction" method="post" enctype="multipart/form-data"> 
                <table>
                <tr>
                	 	<td class="text"></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="GG" name="gb.gname"></td>
                    	<td id="resultName"></td>
                    </tr>
                    <tr>
                        <td class="text">所属分类：</td>
                        <td >大分类<select name="gb.supid" id="bigClass" >
                       		 <option value=-1>请选择</option>
                        	<%-- <c:forEach items="${ls }" var="sup">
                         	 <option value="${sup.supid }">${sup.supname }</option>
                         	</c:forEach>  --%>
                          
                        </select>小分类<select name="gb.subid" id="smallClass">
                       		 <option value=-1>请选择</option>
                        </select>
                    ...
                    <tr>
                        <td class="text">价格：</td>
                        <td><input type="text" class="GG" name="gb.gprice"></td>
                    	<td id="resultPrice"></td>
                    </tr>
                    <tr>
                        <td class="text">剩余数量：</td>
                        <td><input type="text" class="GG" name="gb.gnumber"></td>
                   		<td id="resultSurplus"></td>
                    </tr>
                    <tr>
                        <td class="text">图片：</td>
                        <td><input type="file" id="file" name="gbigpic"><span id="resultFile"></span></td>
                    </tr>
